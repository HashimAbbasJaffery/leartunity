...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="search flex justify-end mr-3">
        <form name="q" id="q">
            <input type="text" value="{{ $keyword }}" name="keyword" id="search" style="border-radius: 0px; width: 20%; height: 25px; font-size: 14px; padding-left: 10px;" placeholder="@lang('Enter Username')">
            ...
            @foreach($users as $user)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="flex items-center px-6 py-4">
                        ...
                        <button type="button" data-context="1" data-id="{{ $user->id }}" class="ban-{{ $user->id }} ban-button {{ $user->isBanned() ? "none" : "" }} focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">@lang('Ban')</button>
                        <button type="button" data-context="0" data-id="{{ $user->id }}" class="unban-{{ $user->id }} ban-button {{ $user->isNotBanned() ? "none" : "" }} focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">@lang('Unban')</button>
